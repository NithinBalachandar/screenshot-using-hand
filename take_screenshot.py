    ...
    if results.multi_hand_landmarks:
        for hand_landmark in results.multi_hand_landmarks:
            ...
            if all(finger_fold_status):
                ...
                cv2.imwrite("inMemoryToDisk.png", image)
                pyautogui.screenshot("straightToDisk.png")
                image = cv2.imread("straightToDisk.png")
                cv2.imshow("display", imutils.resize(image,width=600))        
